...
export const siteConfig: SiteConfig = {
	title: "Clara Herta's Archives",
	subtitle: "Ad astra.",
	siteURL: "https://clara-mizuki-site.pages.dev/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-08-22", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "3493104483043576", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
